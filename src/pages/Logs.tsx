...
export default function Logs() {
  ...
  const [activeTab, setActiveTab] = usePersistentState<"today" | "archive">(
    "logsActiveTab",
    "today",
  );
  ...
  const archivedDates = Object.keys(archivedLogsByDate).sort(
          ...
          >
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-sm transition-shadow hover:shadow-lg hover:-translate-y-1 transform duration-200">
              <div className="flex items-center justify-between space-x-2 mb-2">
                ...
                <time className="font-mono text-xs font-bold text-neutral-400 bg-neutral-100 dark:bg-neutral-800 px-2.5 py-1 rounded-lg tracking-wider">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div>
            ...
            <p className="text-neutral-500 font-medium mt-1">
              Audit trail of recent application activities
            </p>
          </div>
        </div>
